        ...
        use: {
          ...
          options:{
            // byte 限制,超过该值则打包为文件,否则保存为base64,直接渲染在html中,减少了http请求;大的文件单独保存,方便缓存到浏览器
              ...
              publicPath:process.env.NODE_ENV=='production'?`/p1/lib${CURRENT_VERSION}/image/`:`/lib${CURRENT_VERSION}/image/`
          }
        }
      },
      // 字体处理,与图片处理方法一致
      {
        ...
        use:{
          ...
          options:{
              ...
              publicPath:process.env.NODE_ENV=='production'?`/p1/lib${CURRENT_VERSION}/font/`:`/lib${CURRENT_VERSION}/font/`
          }
        }
      }
    ]
